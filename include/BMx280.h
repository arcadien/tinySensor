...
public:
  BMx280(Hal *hal) : hal(hal) { _bmX280.setI2CAddress(0x76); }

  void Begin() { _bmX280.beginI2C(); }
  ...
  bool IsMeasuring() { return _bmX280.isMeasuring(); }
  void Shutdown() { return _bmX280.setMode(MODE_SLEEP); }
